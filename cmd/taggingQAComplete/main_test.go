...
func TestTaggingQAComplete(t *testing.T) {

	cfg := config.GetConfigPointer()
	servicePrefix := "tagging-qa-complete-dot-" // <---- change to match service!!
	port := cfg.TaskTaggingQACompletePort       // <---- change to match service!!
