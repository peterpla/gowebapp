...
func TestTaggingComplete(t *testing.T) {

	cfg := config.GetConfigPointer()
	servicePrefix := "tagging-complete-dot-" // <---- change to match service!!
	port := cfg.TaskTaggingCompletePort      // <---- change to match service!!
